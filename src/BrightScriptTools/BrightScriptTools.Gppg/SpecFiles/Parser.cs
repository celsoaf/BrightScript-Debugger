...
// Machine:  CELSO-PC
// DateTime: 05/10/2016 17:10:45
// UserName: Celso
// Input file <SpecFiles\BrightScript.y - 05/10/2016 17:10:31>
...
#line default
        break;
      case 56: // LabelSeparator -> Eol, EolOpt
#line 161 "SpecFiles\BrightScript.y"
               { CurrentSemanticValue = BuildLabelSeparatorNode(LocationStack[LocationStack.Depth-2]); }
#line default
        break;
      case 57: // LabelSeparator -> comma
#line 162 "SpecFiles\BrightScript.y"
...
#line default
        break;
      case 69: // IndexExpression -> SequenceExpression, lBrac, SequenceExpression, rBrac
#line 192 "SpecFiles\BrightScript.y"
