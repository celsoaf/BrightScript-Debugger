...
namespace RokuTelnet
{
    ...
    {
        public static readonly RoutedUICommand DebuggerStepIn = new RoutedUICommand("Debugger Step", "DebuggerStepIn", typeof(ShellView), new InputGestureCollection() { new KeyGesture(Key.F11) });
        public static readonly RoutedUICommand DebuggerStepOver = new RoutedUICommand("Debugger Step", "DebuggerStepOver", typeof(ShellView), new InputGestureCollection() { new KeyGesture(Key.F10) });
        public static readonly RoutedUICommand DebuggerStepOut = new RoutedUICommand("Debugger Step", "DebuggerStepOut", typeof(ShellView), new InputGestureCollection() { new KeyGesture(Key.F11, ModifierKeys.Shift) });
