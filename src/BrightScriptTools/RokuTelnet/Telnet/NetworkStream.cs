...
namespace RokuTelnet.Telnet
{
    ...
    public class NetworkStream : INetworkStream
    {
        ...
        /// 
        /// </summary>
        /// <param name="buffer">The buffer.</param><param name="offset">The offset.</param><param name="count">The count.</param><param name="cancellationToken">The cancellationToken.</param>
        /// <returns>
        /// An awaitable task.
        /// 
        /// </returns>
